...
#define Current_sensor_Value 100
...
void cal(){
  ...
  Channel1_Power = (abs(Irms0_out * Vrms0_out * Pf0)) / 12;
  Channel2_Power = (abs(Irms1_out * Vrms1_out * Pf1)) / 12;
  Channel3_Power = (abs(Irms2_out * Vrms2_out * Pf2)) / 12;

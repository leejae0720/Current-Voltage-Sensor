...
void loop() {
  ...
  // Channel 1
  Channel1_Power = Current0_X * Voltage0_X * cos(Current0_theta - Voltage0_theta);

  // Channel 2
  Channel2_Power = Current1_X * Voltage1_X * cos(Current1_theta - Voltage1_theta);

  // Channel 3
  Channel3_Power = Current2_X * Voltage2_X * cos(Current2_theta - Voltage2_theta);
  }
